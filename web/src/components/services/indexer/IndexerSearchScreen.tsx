...
export function IndexerSearchScreen({ definition, instance }: { definition: ServiceDefinition; instance: ServiceInstance }) {
    ...
    <div>
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manual search</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          {!search.isPending && results === null && (
            <p className="text-sm text-muted-foreground">Search for something to get started.</p>
          )}
          {!search.isPending && results !== null && results.length === 0 && (
